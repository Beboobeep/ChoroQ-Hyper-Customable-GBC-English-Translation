...
INPUT_ROM = "eng_infGold_3LineTextIns.gbc" # 3 line text test
OUTPUT_ROM = "Choro Q - Hyper Customable GB_EnglishInfGold_3LineText_Test.gbc" #3 line text test

# Translation files for each module
TRANSLATION_FILES = {
    'full_dialogue': "choroq_full_translation_file_3Line_text_test.txt",  # New 3 line test check
